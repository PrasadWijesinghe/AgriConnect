    ...
    return (
      <main className="mx-auto max-w-6xl px-6 py-16">
        <section className="rounded-3xl bg-white px-8 py-10 shadow-xl ring-1 ring-gray-100">
          ...
          <p className="mt-3 text-gray-600">Sign in to view harvest requests and respond with your available harvest.</p>
      ...
      <section className="rounded-3xl bg-white px-8 py-10 shadow-xl ring-1 ring-gray-100">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-gray-600">Browse requests and respond with your available harvest.</p>
          </div>
